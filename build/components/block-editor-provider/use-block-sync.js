...
function useBlockSync(_ref) {
  var _ref$clientId = _ref.clientId,
      ...
      onInput = _ref$onInput === void 0 ? _lodash.noop : _ref$onInput;
  ...
  var pendingChanges = (0, _element.useRef)({
    incoming: null,
    outgoing: []
  });
  ...
  var onInputRef = (0, _element.useRef)(onInput);
  var onChangeRef = (0, _element.useRef)(onChange);
