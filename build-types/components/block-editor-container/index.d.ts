...
export type OnError = import('../../index').OnError;
...
export type OnUpdate = import('../block-editor-contents/index').OnUpdate;
/**
 * Set editing callback
 */
export type OnSetEditing = (isEditing: boolean) => any;
